---
title: "Formative data assignment 2 (SSI2006/3002, 2020-21)"
...
In this part you will need to reproduce five ggplot graphs. I supply graphs as images (please see https://github.com/datan3-2020/assignment4/blob/master/assignment4.md); you need to write the ggplot2 code to reproduce them and knit and submit a document with the reproduced graphs and your code.
...
In this part we will revisit data on ethnic intermarriage from assignment 2. First we need to read and join the data. I provide the code for this; as usual you'll need to add the file paths.
...
```{r}
# Let us generate some data from a fictional population of 110 couples.
