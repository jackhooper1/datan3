...
The 2016 referendum resulted in a larger 'Leave' vote than 'Remain'. This survey seems to indicate that the result would be 'Remain'. This suggests that people may have not responded honestly to the survey question. Could be due to them feeling the 'correct' answer is to vote 'Remain'. This may be supported by the fact that in the survey 10% of respondants either chose not to answer the question or 'missed' it out -"NA".
...
Remain =1
Leave =0
Age: Above 55yrs, people overwhelming voted to Leave. Below 55, "remain".
Sex: Fairly equal. Age seems more significant predictor of vote.
Non-response: Fairly equal across sex, slightly larger as age increases
...
h_indresp %>%
  select(h_nchild, h_hidp) %>%
  summary()

Egoalt8 %>%
  select(h_hidp, h_racel)
```
